...
export default function ApiTestPage() {
  ...
  const testApi = async (key: string, endpoint: string, params: Record<string, any>) => {
    ...
    console.log("queryString :", queryString, "url :", url);
      ...
      apis: [
        {
          ...
          params: { base_date: dt.baseDate, base_time: dt.baseTime, nx: "60", ny: "127" },
        },
        {
          key: "ultra-srt-fcst",
          name: "초단기예보",
          endpoint: "/api/ultra-srt-fcst",
          params: { base_date: dt.baseDate, base_time: dt.baseTime, nx: "60", ny: "127" },
        },
        {
          key: "forecast",
          ...
          params: { base_date: dt.baseDate, base_time: "0500", nx: "60", ny: "127" },
        },
      ],
    },
    {
      ...
      apis: [
        {
          key: "mid-land",
          name: "중기육상예보",
          endpoint: "/api/mid-land",
          params: { regId: "11B00000", tmFc: dt.tmFc },
        },
    ...
    },
    {
      ...
      apis: [
        { key: "tm-coord", name: "TM 좌표 조회", endpoint: "/api/tm-coord", params: { umdName: "정자동" } },
        {
          key: "nearby-station",
          name: "근접 측정소 조회",
          endpoint: "/api/nearby-station",
          params: { tmX: "200000", tmY: "450000" },
        },
        { key: "sido-dust", name: "시도별 먼지 정보", endpoint: "/api/sido-dust", params: { sidoName: "서울" } },
        {
          ...
          name: "측정소별 실시간 정보",
          endpoint: "/api/dust",
          params: { stationName: "종로구", dataTerm: "DAILY" },
        },
      ],
    },
    {
      ...
      apis: [
        { key: "uv", name: "자외선지수", endpoint: "/api/uv", params: { areaNo: "1100000000", time: dt.time } },
        {
          key: "air-diffusion",
          name: "대기정체지수",
          endpoint: "/api/air-diffusion",
          params: { areaNo: "1100000000", time: dt.time },
        },
        {
          key: "kakao",
          name: "카카오 주소 변환",
          endpoint: "/api/kakao-address",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {apiGroups.map((group) => (
            <div
              key={group.title}
              className="bg-slate-800/50 backdrop-blur-xl rounded-3xl p-6 border border-slate-700/50"
            >
              ...
              <div className="space-y-4">
                {group.apis.map((api) => (
                  <div
                    key={api.key}
                    className="bg-slate-900/50 rounded-2xl p-4 border border-slate-800 transition-all hover:border-cyan-500/30"
                  >
